<?php
    ...
    $inscricao->setInscricao($_REQUEST['inscricao']);
    $resultado = $inscricao->inscrNum($_REQUEST['inscricao']);
    var_dump($resultado);
    if($exect){
        $inscricao->deletar();
    }
    echo $vagas = $resultado[0]['vagas'];
    echo ++$vagas;
    echo $idcurso = $resultado[0]['idcurso'];
    echo $curso->numvagas($idcurso,$vagas);
